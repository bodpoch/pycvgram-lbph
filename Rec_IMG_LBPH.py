...
face_cascade = cv2.CascadeClassifier(filepath + 'Haar/haarcascade_frontalface_alt2.xml')
eye_cascade = cv2.CascadeClassifier(filepath + 'Haar/haarcascade_eye.xml')
spec_cascade = cv2.CascadeClassifier(filepath + 'Haar/haarcascade_eye_tree_eyeglasses.xml')
...
img = cv2.imread(filepath + 'MYIMG.jpg')  # ------->>> THE ADDRESS TO THE PHOTO
